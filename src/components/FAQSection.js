...
const faqs = [
  ...
  {
    question:
      "Is  Opus Paints Franchise different from Trade / Retail products?",
    answer:
  ...
  {
    question:
      "How many types of Paints are offered by  Opus Paints Franchise?",
    answer:
  ...
  {
    question:
      "What is the major difference between interior and exterior paints?",
    answer:
      ...
      <div className={styles.faqInner}>
        <header className={styles.header}>
          ...
          <p className={styles.subtext}>
            Find quick answers about  Opus Paints Franchise, products, and
            services to help you plan your next project with confidence.
          </p>
        </header>
